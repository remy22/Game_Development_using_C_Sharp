...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        //Create constant variable for windows width and height
        ...
        protected override void LoadContent()
        {
            ...
            quit = new QuitButton(Content, WINDOW_WIDTH / 2, WINDOW_HEIGHT - 70, GameState.Quit);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameState == GameState.Play)
            {
                if (whoseTurn == PlayerType.Human)
                {
                    ...
                    bool tookTurn = board.TakePlayerTurn(mouse);
            ...
            if (board.GameOver() == true && gameState == GameState.Play)
            {
                quit.Visible = true;
